...
const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://files.catbox.moe/88fi1v.png";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "© POWERED BY PRINCE";
const DEV = process.env.DEV || 'PRINCE';
...
👇 Chagua option hapa chini`;
    ...
    await conn.sendMessage(from, {
        ...
        buttons: [
            { buttonId: `${userPrefix}fullmenu`, buttonText: { displayText: "📜 Full Menu" }, type: 1 },
            { buttonId: `${userPrefix}helpcenter`, buttonText: { displayText: "🆘 Help Center" }, type: 1 },
            { buttonId: `${userPrefix}owner`, buttonText: { displayText: "👑 Owner" }, type: 1 }
        ],
    ...
    await conn.sendMessage(from, {
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: "𝙿𝚁𝙸𝙽𝙲𝙴 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃",
                serverMessageId: 200
            },
            externalAdReply: {
